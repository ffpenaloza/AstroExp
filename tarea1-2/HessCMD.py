...
def plotHess(mag, color, levels='none', xlims=[-0.5,2], ylims=[25,16], colormap=plt.cm.jet, cbarr='None', cbarrtitle='', xlab='', ylab='', saveas='HessCMD.png'):
    """
    ...
    levels = np.arange(10,step=0.1)
    cntr=plt.contourf(X,Y,Z,levels,cmap=plt.cm.jet,zorder=2)
